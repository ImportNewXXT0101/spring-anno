package com.xxt.spring.cap10.config;

import com.xxt.spring.cap10.aop.Calculator;
import com.xxt.spring.cap10.aop.Calculator2;
import com.xxt.spring.cap10.aop.LogAspects;
 ...
 *     环绕通知:动态代理, 需要手动执行joinPoint.procced()(其实就是执行我们的目标方法div,)
 *     , 执行之前div()相当于前置通知, 执行之后就相当于我们后置通知(@Around)
 */
@Configuration
@EnableAspectJAutoProxy
@Import(value= {Calculator2.class })
