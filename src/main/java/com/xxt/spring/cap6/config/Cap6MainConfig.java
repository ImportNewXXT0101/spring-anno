...
import com.xxt.spring.cap6.bean.Cat;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import org.springframework.context.annotation.Import;

import com.xxt.spring.cap6.bean.Dog;

@Configuration
@Import(value = { 
		Dog.class, Cat.class
		, 
		JamesImportSelector.class,
...
public class Cap6MainConfig {
	 ...
	 * 2,包扫描+组件的标注注解
	 * 	(@ComponentScan: 
	 *  	@Controller, @Service  @Reponsitory  @ Componet),
	 *  一般是针对 我们自己写的类,使用这个
	 ...
	 *      	可以手动添加组件到IOC容器, 
	 *      	所有Bean的注册可以使用BeanDifinitionRegistry
	 *          	写JamesImportBeanDefinitionRegistrar
